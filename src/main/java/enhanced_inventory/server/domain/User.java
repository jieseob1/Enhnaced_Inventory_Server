...
public class User extends AuditingFields {
  ...
  /**
   * 회원 일련번호 - 아이디 - 이름 - 비밀번호 - 권한: 일반, 중간 관리자 ,마스터 - 회사 - 연락처: 사용자의 전화번호 또는 내선번호 - 부서: 사용자가 속한 부서
   * 정보 - 직책: 사용자의 직책 또는 직급 - 상태: 사용자 계정의 활성화 여부 (활성, 비활성, 잠금 등)
   * <p>
   * <p>
   * 사용자 인증 및 인가: 사용자의 로그인, 로그아웃, 권한 확인. 사용자 관리: 사용자 생성, 수정, 삭제. 사용자 정보 조회: 사용자의 프로필 정보 조회. 사용자 상태
   * 관리: 사용자 계정의 활성화/비활성화, 계정 잠금 등.
   */
  @Id
  @Column(length = 50)
  ...
  private User(String id, String userPassword, String email, String role, String memo,
  ...
  public static User of(String id, String userPassword, String email, String role, String memo,
      String companyId) {
